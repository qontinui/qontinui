...
class TestClusteringLogic:
    ...
    def test_identical_menu_bar_clustering(self, builder):
        ...
        img1 = TrackedImage(
            id="menu_s1", name="MenuBar", source_screenshot_id="screen1",
            source_bbox={"x":0,"y":0,"width":100,"height":20},
            image_data=menu_bar_texture, screens_found={"screen1"},
            extraction_category="static"
        )
        img2 = TrackedImage(
            id="menu_s2", name="MenuBar", source_screenshot_id="screen2",
            source_bbox={"x":0,"y":0,"width":100,"height":20},
            image_data=menu_bar_texture, screens_found={"screen2"},
            extraction_category="static"
        )
        img3 = TrackedImage(
            id="menu_s3", name="MenuBar", source_screenshot_id="screen3",
            source_bbox={"x":0,"y":0,"width":100,"height":20},
            image_data=menu_bar_texture, screens_found={"screen3"},
            extraction_category="static"
        )
        ...
        assert len(state["stateImages"]) == 3, "Should have 3 stateImages (one per screen) for correct bbox tracking"
    ...
    def test_slightly_different_sizes_clustering(self, builder):
        ...
        img1 = TrackedImage(
            id="s1", name="Btn", source_screenshot_id="screen1",
            source_bbox={"x":0,"y":0,"width":100,"height":20},
            image_data=texture_base, screens_found={"screen1"}
        )
        img2 = TrackedImage(
            id="s2", name="Btn", source_screenshot_id="screen2",
