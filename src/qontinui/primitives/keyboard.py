...
from ..actions import (
    Action, ActionConfig, ActionResult, 
    TypeOptions, KeyDownOptions, KeyUpOptions,
    KeyModifier
)
...
class KeyPress(Action):
    ...
    def execute_key(self, key: str) -> ActionResult:
        ...
        """
        return self.execute(
            lambda: self._pure.key_press(key),
            target=key
        )
...
class KeyDown(Action):
    ...
    def __init__(self, config: Optional[KeyDownOptions] = None):
...
class KeyUp(Action):
    ...
    def __init__(self, config: Optional[KeyUpOptions] = None):
...
class TypeText(Action):
    ...
    def __init__(self, config: Optional[TypeOptions] = None):
