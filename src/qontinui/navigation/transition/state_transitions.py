...
class StateTransitions:
    ...
    transition_finish: Optional[StateTransition] = None
    """Transition executed when arriving at this state."""
    
    action_definition_transitions: Dict[int, 'TaskSequenceStateTransition'] = field(default_factory=dict)
    ...
    def get_transition_function_by_activated_state_id(self, to: int) -> Optional[StateTransition]:
    ...
    def add_transition(self, transition: StateTransition) -> None:
        ...
        if hasattr(transition, '__class__') and transition.__class__.__name__ == 'TaskSequenceStateTransition':
...
class StateTransitionsBuilder:
    ...
    def add_transition(self, transition: Callable[[], bool], *to_states: str) -> 'StateTransitionsBuilder':
    ...
    def add_transition_finish(self, transition_finish: Callable[[], bool]) -> 'StateTransitionsBuilder':
