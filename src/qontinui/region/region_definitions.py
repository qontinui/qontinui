...
from .anchor import AnchorPoint
...
class RegionDefinitions:
    ...
    def define_dynamic(self, name: str, 
                      factory: Callable[[], Region]) -> 'RegionDefinitions':
    ...
    def get(self, name: str, cache: bool = True) -> Optional[Region]:
