...
class RelativeRegion:
    ...
    @staticmethod
    def get_adjacent(reference: Region, direction: Direction, 
    ...
    @staticmethod
    def get_grid_region(reference: Region, 
                       row: int, col: int,
                       rows: int, cols: int,
                       gap: int = 0) -> Region:
    ...
    @staticmethod
    def get_columns(reference: Region, num_columns: int, 
                   gap: int = 0) -> List[Region]:
    ...
    @staticmethod
    def get_rows(reference: Region, num_rows: int, 
                gap: int = 0) -> List[Region]:
    ...
    @staticmethod
    def align_horizontal(regions: List[Region], gap: int = 0, 
                        y: Optional[int] = None) -> List[Region]:
    ...
    @staticmethod
    def align_vertical(regions: List[Region], gap: int = 0,
                      x: Optional[int] = None) -> List[Region]:
