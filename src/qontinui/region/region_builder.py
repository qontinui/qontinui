...
class RegionBuilder:
    ...
    def __init__(self):
        ...
        self._reference: Region | None = None
        self._reference_anchor: AnchorPoint | None = None
        self._self_anchor: AnchorPoint | None = None
    ...
    def align_to_anchor(
        self, region: Region, from_anchor: AnchorPoint, to_anchor: AnchorPoint
    ) -> "RegionBuilder":
    ...
    def build(self) -> Region:
        ...
        return Region(x=self._x, y=self._y, width=self._width, height=self._height, name=self._name)
