...
from ..model.element import Region, Location
from ..find import Match
...
class MockActionHistoryFactory:
    ...
    def reliable_button(region: Region, success_rate: float = 0.98) -> ActionHistory:
        ...
        """
        return MockActionHistoryBuilder() \
    ...
    @staticmethod
    def lower_left_element(width: int = 200, height: int = 80, 
                           success_rate: float = 0.95) -> ActionHistory:
    ...
    @staticmethod
    def for_screen_position(position: str, width: int, height: int,
                           success_rate: float = 0.92) -> ActionHistory:
