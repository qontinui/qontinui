...
class ScrollOptions(ActionConfig):
    ...
    def __init__(self, builder: "ScrollOptionsBuilder") -> None:
        ...
        self.direction: ScrollDirection = builder.direction
        self.clicks: int = builder.clicks
        self.smooth: bool = builder.smooth
        self.delay_between_scrolls: float = builder.delay_between_scrolls
