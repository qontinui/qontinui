...
from .mouse_press_options import MousePressOptions, MouseButton
...
class MouseDownOptions(ActionConfig):
    ...
    def __init__(self, builder: 'MouseDownOptionsBuilder'):
        ...
        self.press_options = builder.press_options
...
class MouseDownOptionsBuilder(ActionConfigBuilder):
    ...
    def __init__(self, original: Optional[MouseDownOptions] = None):
        """Initialize builder.
        ...
        if original:
            ...
            self.press_options = (MousePressOptions.builder()
