...
from ..mouse.mouse_press_options import MousePressOptions
...
class ClickOptionsBuilder(ActionConfigBuilder):
    ...
    def set_verification(
        self, verification_options_builder: VerificationOptionsBuilder
    ) -> "ClickOptionsBuilder":
    ...
    def set_repetition(
        self, repetition_options_builder: RepetitionOptionsBuilder
    ) -> "ClickOptionsBuilder":
