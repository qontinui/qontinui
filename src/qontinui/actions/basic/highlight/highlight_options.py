...
class HighlightOptions(ActionConfig):
    ...
    def __init__(self, builder: 'HighlightOptionsBuilder'):
        ...
        self.highlight_duration = builder.highlight_duration
        self.color = builder.color
        self.thickness = builder.thickness
        self.flash = builder.flash
        self.flash_times = builder.flash_times
...
class HighlightOptionsBuilder(ActionConfigBuilder['HighlightOptionsBuilder']):
    ...
    def __init__(self, original: Optional[HighlightOptions] = None):
        """Initialize builder.
