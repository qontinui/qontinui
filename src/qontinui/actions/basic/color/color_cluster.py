...
class ColorClusterAnalyzer:
    ...
    def analyze_image(self, image: np.ndarray, n_clusters: Optional[int] = None) -> List[ColorCluster]:
        ...
        logger.debug(f"Found {len(clusters)} color clusters, "
    ...
    def match_color_in_image(self, image: np.ndarray, target_color: RGB, 
