...
from .....model.element.image import Image
...
class PatternFindOptions(BaseFindOptions):
    ...
    def enable_scale_invariant(self, min_scale: float = 0.8, 
                              max_scale: float = 1.2) -> 'PatternFindOptions':
    ...
    def enable_rotation_invariant(self, min_rotation: float = -15.0,
                                 max_rotation: float = 15.0) -> 'PatternFindOptions':
    ...
    def use_edges(self, threshold1: float = 50.0, 
                  threshold2: float = 150.0) -> 'PatternFindOptions':
