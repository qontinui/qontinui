...
class TextFindOptions(BaseFindOptions):
    ...
    # Preprocessing
    preprocessing: List[TextPreprocessing] = field(default_factory=lambda: [TextPreprocessing.GRAYSCALE])
    ...
    def case_sensitive(self, sensitive: bool = True) -> 'TextFindOptions':
