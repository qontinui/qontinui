...
from .match_fusion_options import MatchFusionOptions, FusionMethod
...
class PatternFindOptions(BaseFindOptions):
    ...
    def for_precise_search() -> 'PatternFindOptions':
        ...
        """
        fusion_options = (MatchFusionOptions.builder()
...
class PatternFindOptionsBuilder(BaseFindOptionsBuilder['PatternFindOptionsBuilder']):
    ...
    def __init__(self, original: Optional[PatternFindOptions] = None):
        """Initialize builder.
    ...
    def set_match_fusion(self, match_fusion_options: MatchFusionOptions) -> 'PatternFindOptionsBuilder':
