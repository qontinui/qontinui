...
from .options.base_find_options import BaseFindOptions, FindStrategy
...
class FindPipeline:
    ...
    def execute(self, object_collection: ObjectCollection, 
                options: BaseFindOptions) -> List[Match]:
    ...
    def _preprocess(self, object_collection: ObjectCollection, 
                    options: BaseFindOptions) -> tuple[ObjectCollection, BaseFindOptions]:
    ...
    def _execute_strategy(self, object_collection: ObjectCollection,
                         options: BaseFindOptions) -> List[Match]:
    ...
    def _fallback_find(self, object_collection: ObjectCollection,
                      options: BaseFindOptions) -> List[Match]:
    ...
    def _postprocess(self, matches: List[Match], 
                    options: BaseFindOptions) -> List[Match]:
    ...
    def _apply_search_type(self, matches: List[Match], 
                          options: BaseFindOptions) -> List[Match]:
        """Apply search type filtering.
    ...
    def _generate_cache_key(self, object_collection: ObjectCollection,
                           options: BaseFindOptions) -> str:
