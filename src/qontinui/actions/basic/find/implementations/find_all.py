...
class FindAll:
    ...
    def _sliding_window_search(self, object_collection: ObjectCollection,
                              options: PatternFindOptions) -> List[Match]:
        ...
        # Get search regions
        search_regions = options.search_regions if options.search_regions else [
            Region(0, 0, 1920, 1080)  # Placeholder for full screen
        ]
        ...
        for region in search_regions:
            ...
            for pattern in options.patterns:
                ...
                for y in range(region.y, region.y + region.height - pattern_height, self.window_step):
                    for x in range(region.x, region.x + region.width - pattern_width, self.window_step):
    ...
    def _filter_duplicates(self, matches: List[Match],
                          options: PatternFindOptions) -> List[Match]:
    ...
    def _filter_overlapping(self, matches: List[Match],
                           options: PatternFindOptions) -> List[Match]:
    ...
    def _filter_by_distance(self, matches: List[Match],
                           options: PatternFindOptions) -> List[Match]:
    ...
    def _calculate_overlap(self, region1: Optional[Region],
                          region2: Optional[Region]) -> float:
    ...
    def _calculate_distance(self, loc1: Optional[Location],
                           loc2: Optional[Location]) -> float:
