...
class Find(ActionInterface):
    ...
    def perform(self, matches: ActionResult, *object_collections: ObjectCollection) -> None:
        ...
        if self.find_pipeline:
            ...
            print(f"FindPipeline not available, performing placeholder find")
            matches.set_success(False)
...
class FindPipeline:
    ...
    def execute(self, find_options: BaseFindOptions, matches: ActionResult, 
