...
class BaseFindOptions(ActionConfig, ABC):
    ...
    def __init__(self, builder: 'BaseFindOptionsBuilder'):
        ...
        self.similarity = builder.similarity
        self.search_regions = builder.search_regions
        self.capture_image = builder.capture_image
        self.use_defined_region = builder.use_defined_region
        self.max_matches_to_act_on = builder.max_matches_to_act_on
        self.match_adjustment_options = builder.match_adjustment_options
        self.search_duration = builder.search_duration
...
class BaseFindOptionsBuilder(ActionConfigBuilder, Generic[TBuilder]):
    ...
    def __init__(self, original: Optional[BaseFindOptions] = None):
        """Initialize builder.
