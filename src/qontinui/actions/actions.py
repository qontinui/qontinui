...
from .fluent import FluentActions, ActionResult
from .pure import PureActions
from ..model.element import Pattern, Region, Location
...
class Actions:
    ...
    def _ensure_mock_initialized(self):
        ...
        if not self._mock_mode_checked:
            ...
            from ..mock import MockModeManager, MockFind, MockActions
    ...
    def find(self, target: Pattern, region: Optional[Region] = None) -> ActionResult:
    ...
    def type(self, text: str, target: Optional[Any] = None) -> ActionResult:
    ...
    def _get_location(self, target: Any) -> Optional[Location]:
