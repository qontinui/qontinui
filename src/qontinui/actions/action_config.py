...
class LoggingOptions:
    ...
    before_action_message: Optional[str] = None
    after_action_message: Optional[str] = None
...
class ActionConfig(ABC):
    ...
    def get_success_criteria(self) -> Optional[Callable[['ActionResult'], bool]]:
...
class ActionConfigBuilder(ABC):
    ...
    def __init__(self, original: Optional[ActionConfig] = None):
    ...
    def set_success_criteria(self, criteria: Callable[['ActionResult'], bool]) -> 'ActionConfigBuilder':
