...
from .....model.action.action_record import ActionRecord, ActionRecordBuilder
...
class ExecutionContext:
    ...
    def __init__(self, action: ActionInterface, target: Optional[Any] = None):
...
class ActionExecutor:
    ...
    def execute(self, action: ActionInterface, target: Optional[Any] = None) -> bool:
    ...
    def _record_execution(self, context: ExecutionContext):
        ...
        record = builder.with_text(context.action.__class__.__name__) \
