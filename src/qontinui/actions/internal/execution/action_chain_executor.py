...
class ActionChainExecutor:
    ...
    def execute_chain(self,
        ...
        current_result = self._execute_action(
            chain_options.get_initial_action(),
            initial_result,
            object_collections
        )
        ...
        if not current_result.is_success():
            final_result.set_success(False)
            return final_result
        ...
        final_result.set_success(current_result.is_success())
    ...
    def _execute_next_in_chain(self,
        ...
        if strategy == ChainingStrategy.NESTED:
            ...
            return self._execute_confirming_action(previous_result, next_action, original_collections)
        else:
            raise ValueError(f"Unknown chaining strategy: {strategy}")
    
    def _execute_nested_action(self,
                              previous_result: ActionResult,
                              next_action: ActionConfig) -> ActionResult:
        ...
        if not search_regions:
            ...
            empty_result.set_success(False)
            return empty_result
    ...
    def _execute_confirming_action(self,
                                  previous_result: ActionResult,
                                  next_action: ActionConfig,
                                  original_collections: tuple) -> ActionResult:
    ...
    def _execute_action(self,
                       ...
                       result: ActionResult,
                       object_collections: tuple = ()) -> ActionResult:
