...
class ActionChain(ActionInterface):
    ...
    def __init__(self, options: Optional[ActionChainOptions] = None):
    ...
    def add(self, action: ActionInterface, target: Optional[Any] = None,
            **kwargs) -> 'ActionChain':
        """Add action to chain.
    ...
    def add_type(self, text: str, target: Optional[Any] = None) -> 'ActionChain':
    ...
    def add_conditional(self, action: ActionInterface, 
                       condition: Callable[[], bool],
                       target: Optional[Any] = None) -> 'ActionChain':
    ...
    def add_with_callbacks(self, action: ActionInterface,
    ...
    def _record_action(self, chain_action: ChainAction, 
