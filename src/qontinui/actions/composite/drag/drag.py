...
class Drag(ActionInterface):
    ...
    def _build_action_chain(self,
                           ...
                           target_collection: ObjectCollection) -> ActionChainOptions:
        ...
        find_source_options = self._create_find_options(
            drag_options.get_find_source_options(),
            source_collection
        )
        
        # Step 2: Find target location
        find_target_options = self._create_find_options(
            drag_options.get_find_target_options(),
            target_collection
        )
        ...
        chain_options = (ActionChainOptionsBuilder(find_source_options)
    ...
    def _create_find_options(self,
                           base_options: Optional[PatternFindOptions],
                           collection: ObjectCollection) -> PatternFindOptions:
        ...
        return (PatternFindOptionsBuilder()
                .set_do_on_each(False)
                .set_action_duration(2.0)
                .build())
    
    def _create_move_options(self,
                           base_options: Optional[MouseMoveOptions]) -> MouseMoveOptions:
        ...
        return (MouseMoveOptionsBuilder()
                .set_move_after_click(False)
                .build())
    
    def _create_mouse_down_options(self,
                                  base_options: Optional[MouseDownOptions]) -> MouseDownOptions:
    ...
    def _create_mouse_up_options(self,
                                base_options: Optional[MouseUpOptions]) -> MouseUpOptions:
    ...
    def _copy_results(self, source: ActionResult, target: ActionResult) -> None:
        ...
        """
        target.set_success(source.is_success())
