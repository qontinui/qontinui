...
class RepetitionOptions:
    ...
    def to_builder(self) -> "RepetitionOptionsBuilder":
        ...
        builder.times_to_repeat_individual_action = (
            self.times_to_repeat_individual_action
        )
...
class RepetitionOptionsBuilder:
    ...
    def set_times_to_repeat_individual_action(
        self, times: int
    ...
    def set_pause_between_individual_actions(
        self, pause: float
    ) -> "RepetitionOptionsBuilder":
