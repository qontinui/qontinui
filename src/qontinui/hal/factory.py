...
from .interfaces import (
    IScreenCapture, IPatternMatcher, IInputController, 
    IOCREngine, IPlatformSpecific
)
...
class HALFactory:
    ...
    @classmethod
    def get_screen_capture(cls, config: Optional[HALConfig] = None) -> IScreenCapture:
    ...
    @classmethod
    def get_pattern_matcher(cls, config: Optional[HALConfig] = None) -> IPatternMatcher:
    ...
    @classmethod
    def get_input_controller(cls, config: Optional[HALConfig] = None) -> IInputController:
    ...
    @classmethod
    def get_ocr_engine(cls, config: Optional[HALConfig] = None) -> IOCREngine:
    ...
    @classmethod
    def get_platform_specific(cls, config: Optional[HALConfig] = None) -> IPlatformSpecific:
