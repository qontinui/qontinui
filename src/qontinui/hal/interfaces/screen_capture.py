...
class IScreenCapture(ABC):
    ...
    @abstractmethod
    def capture_screen(self, monitor: Optional[int] = None) -> Image.Image:
    ...
    def capture_region(self, x: int, y: int, width: int, height: int,
                      monitor: Optional[int] = None) -> Image.Image:
    ...
    def get_pixel_color(self, x: int, y: int, 
                       monitor: Optional[int] = None) -> Tuple[int, int, int]:
    ...
    @abstractmethod
    def save_screenshot(self, filepath: str, monitor: Optional[int] = None,
