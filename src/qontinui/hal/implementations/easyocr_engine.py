...
from ..interfaces.ocr_engine import IOCREngine, TextRegion, TextMatch
...
class EasyOCREngine(IOCREngine):
    ...
    def get_text_regions(self, image: Image.Image,
    ...
    def find_text(self, image: Image.Image, text: str,
                 case_sensitive: bool = False,
                 confidence: float = 0.8) -> Optional[TextMatch]:
    ...
    def find_all_text(self, image: Image.Image, text: str,
                     case_sensitive: bool = False,
                     confidence: float = 0.8) -> List[TextMatch]:
    ...
    def extract_text_from_region(self, image: Image.Image,
