...
from ..interfaces.pattern_matcher import IPatternMatcher, Match, Feature
...
class OpenCVMatcher(IPatternMatcher):
    ...
    def __init__(self, config: Optional[HALConfig] = None):
        ...
        try:
            self._feature_detectors['sift'] = cv2.SIFT_create()
    ...
    def find_pattern(self, haystack: Image.Image, needle: Image.Image,
                    confidence: float = 0.9,
                    grayscale: bool = False) -> Optional[Match]:
    ...
    def find_all_patterns(self, haystack: Image.Image, needle: Image.Image,
                         confidence: float = 0.9,
    ...
    def find_features(self, image: Image.Image,
                     method: str = 'orb') -> List[Feature]:
    ...
    def match_features(self, features1: List[Feature],
                      features2: List[Feature],
                      threshold: float = 0.7) -> List[Tuple[Feature, Feature]]:
    ...
    def find_template_multiscale(self, haystack: Image.Image,
                                 needle: Image.Image,
                                 scales: List[float] = None,
                                 confidence: float = 0.9) -> Optional[Match]:
    ...
    def compare_histograms(self, image1: Image.Image,
                          image2: Image.Image,
    ...
    def detect_edges(self, image: Image.Image,
