...
class ElementMatcher:
    ...
    def _find_similar_faiss(self, query_embedding: np.ndarray,
                           k: int, threshold: float) -> List[MatchResult]:
    ...
    def _find_similar_sklearn(self, query_embedding: np.ndarray,
                             k: int, threshold: float) -> List[MatchResult]:
    ...
    def match_template(self, template_image: np.ndarray,
                      screenshot: np.ndarray,
                      method: str = "correlation") -> List[MatchResult]:
