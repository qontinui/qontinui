...
class TransitionFunction:
    ...
    # Success/failure callbacks
    on_success: Optional[Callable[[TransitionResult], None]] = None
    on_failure: Optional[Callable[[TransitionResult], None]] = None
    ...
    # Execution state
    _last_result: Optional[TransitionResult] = field(default=None, init=False)
    ...
    def get_last_result(self) -> Optional[TransitionResult]:
    ...
    def __repr__(self) -> str:
        ...
        return (f"TransitionFunction(name='{self.name}', "
