...
class StateTransitionsJointTable:
    ...
    def _add_single_transition(self, from_state: str, transition: StateTransition, 
                              entry: TransitionEntry) -> None:
    ...
    def get_transitions(self, state_name: str) -> Optional[StateTransitions]:
    ...
    def find_transition(self, from_state: str, to_state: str) -> Optional[StateTransition]:
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        with self._lock:
            ...
            return {
                ...
                'most_outgoing_connections': {
                    'state': most_outgoing,
                    'count': max_outgoing
                },
                'most_incoming_connections': {
                    'state': most_incoming,
                    'count': max_incoming
                },
    ...
    def validate(self) -> List[str]:
        ...
        with self._lock:
            ...
            if orphan_targets:
                issues.append(
                    f"Transitions to non-existent states: {orphan_targets}"
                )
