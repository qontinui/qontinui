...
class StateTransitionService:
    ...
    def register_transition(self, transition: StateTransition) -> None:
        ...
        # Track states
        self._registered_states.add(transition.from_state)
    ...
    def register_transitions(self, transitions: StateTransitions) -> None:
        ...
        logger.debug(f"Registered {len(transitions.get_transitions())} transitions for state: {state_name}")
    ...
    def execute_transition(self, from_state: str, to_state: str) -> bool:
        ...
        if transition is None:
            ...
            self._record_transition(from_state, to_state, False, start_time, 
    ...
    def _record_transition(self, from_state: str, to_state: str, success: bool,
                          start_time: float, error: Optional[str] = None) -> None:
