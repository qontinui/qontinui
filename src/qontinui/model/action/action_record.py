...
class ActionRecord:
    ...
    def print(self) -> None:
        ...
        for match in self.match_list:
            print(f" {match.region.x},{match.region.y},{match.region.width},{match.region.height}", end="")
    ...
    def __str__(self) -> str:
        ...
        return (f"ActionRecord(action={self.get_action_type()}, "
    ...
    def __repr__(self) -> str:
        ...
        return (f"ActionRecord(action_config={self.action_config}, "
