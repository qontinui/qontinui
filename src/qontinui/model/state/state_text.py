...
class StateText:
    ...
    owner_state_id: int | None = None  # ID of state that owns this text
    ...
    def with_case_sensitive(self, sensitive: bool = True) -> StateText:
    ...
    def __eq__(self, other) -> bool:
        ...
        return (
            ...
            and self.owner_state_id == other.owner_state_id
