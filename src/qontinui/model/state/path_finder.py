...
class PathFinder:
    ...
    def find_path(self, start: State, end: State) -> Optional[Path]:
    ...
    def find_shortest_path(self, start: State, end: State) -> Optional[Path]:
    ...
    def find_all_paths(self, start: State, end: State, 
    ...
    def _find_shortest_path(self, start: State, end: State) -> Optional[Path]:
        """Find shortest path using BFS.
            ...
            for transition in current_state.transitions:
                ...
                if next_state.name not in visited or self._allow_loops:
                    ...
                    for i, state in enumerate(current_path.states):
                        trans = current_path.transitions[i] if i < len(current_path.transitions) else None
    ...
    def _find_best_path(self, start: State, end: State) -> Optional[Path]:
    ...
    def _find_highest_score_path(self, start: State, end: State) -> Optional[Path]:
    ...
    def _find_most_probable_path(self, start: State, end: State) -> Optional[Path]:
    ...
    def _find_all_paths_recursive(self, current: State, end: State,
                                 visited: Set[str], current_path: Path,
                                 all_paths: List[Path], max_paths: int):
