...
class StateObjectMetadata:
    ...
    owner_state_id: Optional[int] = None
    
    def __init__(self, state_object: Optional['StateObject'] = None):
        ...
        if state_object:
            ...
            self.object_type = state_object.object_type
            self.state_object_name = state_object.name
            self.owner_state_name = state_object.owner_state_name
            self.owner_state_id = state_object.owner_state_id
        else:
    ...
    def __str__(self) -> str:
        ...
        return (f"StateObject: {self.state_object_name}, {self.object_type.value}, "
                f"ownerState={self.owner_state_name}, id={self.state_object_id}, "
                f"owner state id={self.owner_state_id}")
    
    def __repr__(self) -> str:
        """Developer representation."""
        return (f"StateObjectMetadata(id='{self.state_object_id}', "
