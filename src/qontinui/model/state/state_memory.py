...
class StateMemory:
    ...
    def get_state_history(self, limit: Optional[int] = None) -> List['State']:
    ...
    def get_transition_count(self, from_state: str, to_state: str) -> int:
        ...
        Returns:
            Execution count
        """
        return sum(1 for r in self._transition_history 
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        """
        unique_states = len(set(r.state_name for r in self._state_history))
        unique_transitions = len(set((r.from_state, r.to_state) 
    ...
    def __str__(self) -> str:
        ...
        return (f"StateMemory(states={len(self._state_history)}, "
