...
class Path:
    ...
    transitions: List[Optional[StateTransition]] = field(default_factory=list)
    ...
    def add_state(self, state: State, transition: Optional[StateTransition] = None) -> 'Path':
    ...
    def get_state(self, index: int) -> Optional[State]:
        """Get state at index.
    ...
    def get_transition(self, index: int) -> Optional[StateTransition]:
