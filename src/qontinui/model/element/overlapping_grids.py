...
class OverlappingGrids:
    ...
    def __str__(self) -> str:
        ...
        return (f"OverlappingGrids(primary={self.grid.rows}x{self.grid.cols}, "
                f"inner={self.inner_grid.rows}x{self.inner_grid.cols}, "
                f"total_cells={self.get_region_count()})")
    
    def __repr__(self) -> str:
        """Developer representation."""
        return (f"OverlappingGrids(grid={self.grid!r}, "
                f"inner_grid={self.inner_grid!r})")