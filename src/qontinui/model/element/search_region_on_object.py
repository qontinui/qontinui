...
class SearchRegionOnObject:
    ...
    base_object: Optional[StateObject] = None
    ...
    adjacent_width: Optional[int] = None  # Width of adjacent region
    adjacent_height: Optional[int] = None  # Height of adjacent region
    
    # Absolute region (for ABSOLUTE strategy)
    absolute_region: Optional[Region] = None
    ...
    _cached_region: Optional[SearchRegion] = field(default=None, init=False)
    ...
    def adjacent_to(self, position: Position, distance: int = 0,
                   width: Optional[int] = None, 
                   height: Optional[int] = None) -> 'SearchRegionOnObject':
    ...
    def get_search_region(self) -> Optional[SearchRegion]:
    ...
    def _compute_region(self) -> Optional[Region]:
    ...
    def _get_base_region(self) -> Optional[Region]:
    ...
    def _compute_relative_region(self, base: Region) -> Region:
        ...
        """
        return Region(
            base.x + self.offset_x,
            base.y + self.offset_y,
            base.width,
            base.height
        )
    ...
    def _compute_adjacent_region(self, base: Region) -> Region:
        ...
        if self.adjacent_position == Position.TOP:
            return Region(
                base.x,
                base.y - height - self.adjacent_distance,
                width,
                height
            )
            ...
            return Region(
                base.x,
                base.bottom + self.adjacent_distance,
                width,
                height
            )
        elif self.adjacent_position == Position.LEFT:
            return Region(
                base.x - width - self.adjacent_distance,
                base.y,
                width,
                height
            )
            ...
            return Region(
                base.right + self.adjacent_distance,
                base.y,
                width,
                height
            )
    ...
    def __repr__(self) -> str:
        ...
        return (f"SearchRegionOnObject(strategy={self.strategy}, "
