...
class CrossStateAnchor:
    ...
    primary_object: Optional[StateObject] = None
    
    # Default anchor to use when state-specific anchor not found
    default_anchor: Optional[Anchor] = None
    ...
    def get_anchor_for_state(self, state_name: str) -> Optional[Anchor]:
    ...
    def get_location_for_state(self, state_name: str, 
                              base_location: Optional[Location] = None) -> Optional[Location]:
        ...
        if base_location:
            return Location(
                base_location.x + anchor.offset_x,
                base_location.y + anchor.offset_y
            )
    ...
    def __repr__(self) -> str:
        ...
        return (f"CrossStateAnchor(state_anchors={list(self.state_anchors.keys())}, "
