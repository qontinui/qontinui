...
class ApplicationLifecycleService:
    ...
    def __init__(self, shutdown_handler: Optional[QontinuiShutdownHandler] = None):
    ...
    def perform_health_check(self) -> dict:
        ...
        try:
            ...
            health_status['components']['state_management'] = {
                'status': 'healthy',
                'active_states': len(state_memory.get_active_state_names())
            }
        except Exception as e:
            health_status['components']['state_management'] = {
                'status': 'error',
...
_lifecycle_service: Optional[ApplicationLifecycleService] = None
