...
from typing import Optional, Any, Callable, Set, List, Union
...
def transition(
    ...
    activate: Optional[Union[str, Set[str], List[str]]] = None,
    exit: Optional[Union[str, Set[str], List[str]]] = None,
...
def get_transition_metadata(func: Callable) -> Optional[dict]:
