...
from .models import State, Transition, TransitionType, StateGraph
...
class StateTraversal:
    ...
    def find_path(self, start: str, goal: str, 
                 strategy: TraversalStrategy = TraversalStrategy.SHORTEST_PATH) -> Optional[TraversalResult]:
    ...
    def _bfs_search(self, start: str, goal: str) -> Optional[TraversalResult]:
    ...
    def _dfs_search(self, start: str, goal: str, 
                   max_depth: int = 100) -> Optional[TraversalResult]:
    ...
    def _dijkstra_search(self, start: str, goal: str) -> Optional[TraversalResult]:
    ...
    def _a_star_search(self, start: str, goal: str) -> Optional[TraversalResult]:
    ...
    def _random_search(self, start: str, goal: str, 
                      max_steps: int = 1000) -> Optional[TraversalResult]:
    ...
    def _exploratory_search(self, start: str, goal: str) -> Optional[TraversalResult]:
