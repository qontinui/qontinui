...
class SearchRegionDependencyInitializer:
    ...
    def __init__(self,
                 ...
                 dynamic_region_resolver: Optional['DynamicRegionResolver'] = None):
    ...
    def on_states_registered(self, state_count: int) -> None:
        ...
        """
        logger.info(f"SearchRegionDependencyInitializer: Received StatesRegisteredEvent with {state_count} states")
