...
class PythonTestGenerator(TestTranslator):
    ...
    def _get_python_equivalent(self, dependency: Dependency) -> Optional[str]:
    ...
    def generate_test_file_path(self, test_file: TestFile, target_directory: Path) -> Path:
        ...
        file_name_base = python_class_name[4:] if python_class_name.startswith("Test") else python_class_name
