...
from ..core.models import GuiModel, MockUsage, TestFile, TestMethod
...
class BrobotMockAnalyzer(MockAnalyzer):
    ...
    def __init__(self):
        ...
        self.brobot_mock_classes = {
            'BrobotMock', 'MockBrobot', 'BrobotTestMock',
            'StateObjectMock', 'ActionMock', 'RegionMock',
            'ImageMock', 'MatchMock', 'TransitionMock'
        }
        
        # Brobot-specific annotations
        self.brobot_annotations = {
            '@MockBean', '@Mock', '@Spy', '@InjectMocks',
            '@BrobotTest', '@StateTest', '@ActionTest'
        }
    ...
    def _is_brobot_gui_mock(self, mock_usage: MockUsage) -> bool:
        ...
        gui_mock_types = {
            'brobot_state_mock', 'brobot_gui_model', 
