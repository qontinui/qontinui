...
from qontinui.test_migration.core.models import TestFile, TestMethod, TestType, MockUsage
...
class TestIntegrationTestEnvironment:
    ...
    def setup_method(self):
        ...
        # Add mock usage
        self.test_file.mock_usage.append(MockUsage(
            mock_type="spring_mock",
            mock_class="UserService"
        ))
    ...
    def test_extract_components_from_test_file(self):
        ...
        user_service_component = next(
            (c for c in components if c.component_type == "UserService"), 
            None
        )
