...
"""
    ...
    def test_map_brobot_to_qontinui(self):
        ...
        # Test known mappings
        assert "qontinui.actions.Action" in self.engine._map_brobot_to_qontinui("brobot.library.Action")
        assert "qontinui.model.state.State" in self.engine._map_brobot_to_qontinui("brobot.library.State")
