...
""")
    ...
    def test_migration_workflow_with_mocked_components(
        ...
        from ..core.models import TestFile, TestType, TestResults, TestResult
...
""")
        ...
        total_attempts = (
            len(orchestrator.migration_state["migrated_tests"]) + 
            len(orchestrator.migration_state["failed_migrations"])
        )
