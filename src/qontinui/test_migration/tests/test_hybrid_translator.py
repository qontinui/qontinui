...
class TestHybridTestTranslator:
    ...
    def test_try_utility_translation_failure(self, mock_time):
        ...
        with patch.object(self.translator.utility_translator, 'generate_python_test_file') as mock_gen:
...
"""
    ...
    def test_calculate_utility_confidence_complex(self):
        ...
        methods = [TestMethod(name=f"testMethod{i}", body="// complex logic\n" * 20) for i in range(15)]
    ...
    def test_translate_test_method_llm_fallback(self):
        ...
        # Mock utility translator to fail
        with patch.object(self.translator.utility_translator, 'translate_test_method') as mock_utility:
    ...
    def test_translate_assertions_llm_fallback(self):
        ...
        with patch.object(self.translator.utility_translator, 'translate_assertions') as mock_utility:
    ...
    def test_translation_with_exception_handling(self):
        ...
        with patch.object(self.translator.utility_translator, 'generate_python_test_file') as mock_utility:
