...
from qontinui.test_migration.translation.spring_test_adapter import SpringTestAdapter, DependencyContainer
from qontinui.test_migration.core.models import TestFile, TestMethod, TestType, Dependency
...
class TestSpringTestAdapter:
    ...
    def test_handle_spring_annotations_integration(self):
        ...
        with patch.object(self.adapter, '_extract_class_annotations') as mock_class_ann, \
