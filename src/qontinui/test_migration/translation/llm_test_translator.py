...
try:
    ...
    from ..core.models import TestFile, TestMethod, TestType, MockUsage
except ImportError:
...
class LLMTestTranslator(TestTranslator):
    ...
    def enhance_utility_translation(self, utility_result: str, test_file: TestFile) -> LLMTranslationResult:
        """
