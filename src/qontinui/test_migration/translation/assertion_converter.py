...
class AssertionConverter:
    ...
    def _extract_assertion_params(self, assertion_line: str, method_name: str) -> Tuple[List[str], Optional[str]]:
        """
    ...
    def _convert_assert_timeout_preemptively(self, assertion_line: str) -> str:
        ...
        return self._convert_assert_timeout(assertion_line.replace('assertTimeoutPreemptively', 'assertTimeout'))
