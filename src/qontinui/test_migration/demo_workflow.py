...
""")
    ...
    print(f"Created migrated test files:")
...
def main():
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            discovered_tests = demonstrate_discovery_phase(orchestrator, source_dir)
            
            # Demonstrate validation phase
            results = demonstrate_validation_phase(orchestrator, target_dir)
            
            # Demonstrate reporting phase
            report_data = demonstrate_reporting_phase(target_dir)
