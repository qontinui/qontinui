...
Examples:
  ...
  python cli_standalone.py config --create --output migration.json
        ...
        discover_parser = subparsers.add_parser(
            "discover",
            help="Discover Java tests in source directory"
        )
    ...
    def _handle_migrate_command(self, args) -> int:
        ...
        try:
            ...
            print(f"Use 'discover' command to analyze test files in detail.")
    ...
    def _handle_dry_run(self, orchestrator: MinimalMigrationOrchestrator, source: Path, target: Path) -> int:
        """Handle dry run mode."""
