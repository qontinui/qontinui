...
try:
    from ..core.models import Dependency, GuiModel, MockUsage, TestFile, TestType
except ImportError:
    from core.models import Dependency, GuiModel, MockUsage, TestFile, TestType
...
class TestClassifier:
    ...
    def __init__(self):
        ...
        self.integration_indicators = {
            ...
            "path_indicators": [
                "integration", "integrationtest", "it", "e2e", "endtoend", 
                "system", "acceptance", "functional", "component"
            ],
            
            # Class name indicators
            "class_indicators": [
                "integration", "it", "e2e", "system", "acceptance", 
                "functional", "component", "end2end", "endtoend"
            ],
            
            # Spring Boot test annotations
            "spring_annotations": [
                "@SpringBootTest", "@WebMvcTest", "@DataJpaTest", "@JsonTest",
                "@WebFluxTest", "@JdbcTest", "@DataMongoTest", "@RestClientTest",
                "@AutoConfigureTestDatabase", "@TestPropertySource"
            ],
        ...
        self.mock_patterns = {
            ...
            "brobot_mocks": [
                "BrobotMock", "MockBrobot", "BrobotSimulator", "GuiMock",
                "StateSimulator", "ActionMock", "ElementMock"
            ],
            ...
            "mockito_mocks": [
                ...
                "Mockito.mock", "Mockito.spy", "Mockito.when", "Mockito.verify"
            ],
            
            # Mock imports
            "mock_imports": [
                "org.mockito.Mock", "org.mockito.Spy", "org.mockito.InjectMocks",
                "org.mockito.Mockito", "org.mockito.ArgumentCaptor",
        ...
        self.java_library_patterns = {
            ...
            # Spring testing
            "spring_test": ["org.springframework.test", "org.springframework.boot.test"],
                ...
                for pattern in patterns:
                    if pattern in dependency.java_import:
                        if category == "junit" or category == "testng":
                            ...
                            dependency_analysis["assertion_libraries"].append(dependency.java_import)
                        categorized = True
                        break
                if categorized:
                    break
    ...
    def _has_integration_mock_patterns(self, test_file: TestFile) -> bool:
        ...
        try:
            ...
            integration_test_patterns = [
                ...
                "@AutoConfigureTestDatabase", "@Sql", "@Transactional"
            ]
