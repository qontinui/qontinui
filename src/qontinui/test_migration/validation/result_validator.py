...
class PerformanceMetrics:
    ...
    time_ratio: float
    memory_usage_java: Optional[int] = None
    memory_usage_python: Optional[int] = None
    ...
    def performance_delta_percent(self) -> float:
        ...
        if self.java_execution_time == 0:
            return 0.0
        return ((self.python_execution_time - self.java_execution_time) / self.java_execution_time) * 100
...
class ResultValidator:
    ...
    def __init__(self, equivalence_config: Optional[BehavioralEquivalenceCheck] = None):
        """
    ...
    def collect_performance_metrics(
        ...
        for test_name in common_tests:
            ...
            metrics[test_name] = self._calculate_performance_metrics(
                java_result, python_result
            )
    ...
    def _compare_outputs(
        ...
        if java_output == python_output:
            ...
            comparison.similarity_score = self._calculate_similarity_score(java_output, python_output)
    ...
    def _calculate_performance_metrics(
        ...
        time_ratio = (
            ...
            if java_result.execution_time > 0 else 0.0
        )
    ...
    def get_validation_summary(self) -> Dict[str, Any]:
        ...
        different = sum(1 for c in self.validation_history if c.validation_result == ValidationResult.DIFFERENT)
        errors = sum(1 for c in self.validation_history if c.validation_result == ValidationResult.ERROR)
        ...
        return {
            ...
            "comparison_types": {
                comp_type.value: sum(1 for c in self.validation_history if c.comparison_type == comp_type)
            ...
            "comparisons": [
                {
                    ...
                    } if c.performance_metrics else None,
