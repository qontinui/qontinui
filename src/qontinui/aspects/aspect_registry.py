...
from .core import get_lifecycle_aspect
from .monitoring import get_performance_aspect, get_state_transition_aspect
from .recovery import get_error_recovery_aspect
...
class AspectRegistry:
    ...
    def apply_configuration(self) -> None:
        ...
        self.state_transition_aspect.track_success_rates = (
            self.config.state_transition_track_success
        )
        self.state_transition_aspect.generate_visualizations = (
            self.config.state_transition_visualizations
        )
...
_aspect_registry: AspectRegistry | None = None


def get_aspect_registry(config: AspectConfiguration | None = None) -> AspectRegistry:
