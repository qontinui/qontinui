...
class ActionLifecycleAspect:
    ...
    def get_current_context(self) -> Optional[ActionContext]:
    ...
    def wrap_action(self, func: Callable) -> Callable:
        ...
        """
        @wraps(func)
        def wrapper(action_instance: ActionInterface,
                   action_result: ActionResult,
                   *object_collections: ObjectCollection) -> Any:
    ...
    def _pre_execution(self,
        ...
        if self.pre_action_pause > 0:
            logger.trace(f"Pre-action pause: {self.pre_action_pause}s")
    ...
    def _post_execution(self,
        ...
        if self.post_action_pause > 0:
            logger.trace(f"Post-action pause: {self.post_action_pause}s")
    ...
    def get_action_history(self,
                          ...
                          limit: int = 100) -> List[ActionContext]:
