...
class PerformanceMonitoringAspect:
    ...
    def detect_performance_degradation(self, 
                                      method_name: str,
                                      threshold_percent: float = 20) -> bool:
    ...
    def generate_report(self) -> str:
        ...
        with self._stats_lock:
            ...
            report_lines.extend([
                ...
                f"Overall Success Rate: {((total_calls - total_errors) / total_calls * 100):.2f}%" if total_calls > 0 else "N/A",
                "",
...
def performance_monitored(name: Optional[str] = None) -> Callable:
