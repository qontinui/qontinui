...
from .scheduled_task import ScheduledTask, TaskStatus, TaskPriority
...
class StateScheduler:
    ...
    def __init__(self, actions: Optional[Actions] = None, 
        ...
        self._running_task: Optional[ScheduledTask] = None
    ...
    def schedule_task(self, name: str, task_function: Callable[[], bool],
                     required_states: Optional[Set[str]] = None,
                     forbidden_states: Optional[Set[str]] = None,
                     target_state: Optional[str] = None,
                     priority: TaskPriority = TaskPriority.NORMAL,
                     recurring: bool = False) -> ScheduledTask:
