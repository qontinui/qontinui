...
class StateDetector:
    ...
    def check_for_active_states(self, state_ids: Optional[Set[int]] = None) -> bool:
    ...
    def find_state(self, state_identifier: any) -> Optional[State]:
    ...
    def find_expected_states(self, expected_state_ids: Set[int], 
