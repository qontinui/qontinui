...
class ActiveStateSet:
    ...
    states: Set[Union[int, Enum]] = field(default_factory=set)
    
    def add_state(self, state: Union[int, Enum, 'State']) -> 'ActiveStateSet':
    ...
    def add_states(self, *states: Union[int, Enum, 'State']) -> 'ActiveStateSet':
    ...
    def remove_state(self, state: Union[int, Enum, 'State']) -> 'ActiveStateSet':
    ...
    def contains(self, state: Union[int, Enum, 'State']) -> bool:
    ...
    def get_active_states(self) -> Set[Union[int, Enum]]:
    ...
    @staticmethod
    def of(*states: Union[int, Enum, 'State']) -> 'ActiveStateSet':
    ...
    def to_list(self) -> List[Union[int, Enum]]:
        """Convert to list.
    ...
    def __contains__(self, state: Union[int, Enum, 'State']) -> bool:
        """Support 'in' operator.
...
class ActiveStateSetBuilder:
    ...
    def add(self, state: Union[int, Enum, 'State']) -> 'ActiveStateSetBuilder':
        """Add a state.
    ...
    def add_all(self, *states: Union[int, Enum, 'State']) -> 'ActiveStateSetBuilder':
        """Add multiple states.
