...
import numpy as np
from ..model.element import Image, Pattern, Region, Location
...
class FindImage(Find):
    ...
    def __init__(self, image: Optional[Union[Image, str]] = None):
    ...
    def above(self, reference: Union[Match, Region], distance: int = 100) -> 'FindImage':
    ...
    def below(self, reference: Union[Match, Region], distance: int = 100) -> 'FindImage':
    ...
    def left_of(self, reference: Union[Match, Region], distance: int = 100) -> 'FindImage':
    ...
    def right_of(self, reference: Union[Match, Region], distance: int = 100) -> 'FindImage':
