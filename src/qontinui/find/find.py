...
class Find:
    ...
    def __init__(self, target: Optional[Union[Pattern, Image, str]] = None):
        ...
        self._search_region: Optional[SearchRegion] = None
        self._screenshot: Optional[Any] = None
        self._method = "template"  # Default matching method
    
    def _convert_to_pattern(self, target: Union[Pattern, Image, str]) -> Pattern:
    ...
    def search_region(self, region: Union[Region, SearchRegion]) -> 'Find':
        ...
        if isinstance(region, SearchRegion):
            ...
            self._search_region = SearchRegion(
    ...
    def wait_until_exists(self, timeout: float = 10.0) -> Optional[Match]:
        ...
        if self._target and self._screenshot:
            ...
            match_obj = MatchObject(
                ...
                region=Region(100, 100, 
                             self._target.image.width,
                             self._target.image.height),
                similarity=0.95,
                pattern=self._target,
                screenshot=self._screenshot,
                timestamp=time.time()
    ...
    def __repr__(self) -> str:
        ...
        return (f"Find(target={self._target}, "
