...
class FindResults:
    ...
    screenshot: Optional[Any] = None  # Screenshot used for finding
    ...
    def __str__(self) -> str:
        ...
        return (f"FindResults(pattern='{pattern_name}', "
                f"found={self.count} matches, "
                f"duration={self.duration:.3f}s)")
    
    def __repr__(self) -> str:
        """Developer representation."""
        return (f"FindResults(matches={self.matches}, "
    ...
    @classmethod
    def empty(cls, pattern: Optional[Pattern] = None) -> 'FindResults':
