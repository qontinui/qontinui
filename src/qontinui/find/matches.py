...
class Matches:
    ...
    def get(self, index: int) -> Optional[Match]:
    ...
    def sort_by_position(self, top_to_bottom: bool = True, 
                        left_to_right: bool = True) -> 'Matches':
    ...
    def filter_by_distance(self, location: Location, max_distance: float) -> 'Matches':
        ...
        filtered = [m for m in self._matches 
                   if m.center.distance_to(location) <= max_distance]
        return Matches(filtered)
    ...
    def nearest_to(self, location: Location) -> Optional[Match]:
    ...
    def farthest_from(self, location: Location) -> Optional[Match]:
