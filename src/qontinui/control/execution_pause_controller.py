...
class ExecutionPauseController:
    ...
    def check_pause_point(self, name: str, context: Optional[Dict[str, Any]] = None) -> None:
    ...
    def add_conditional_pause_handler(self, 
    ...
    def remove_conditional_pause_handler(self,
                                        handler: Callable[[str, Dict[str, Any]], bool]) -> None:
...
_global_pause_controller: Optional[ExecutionPauseController] = None
...
def check_pause(name: str, context: Optional[Dict[str, Any]] = None) -> None:
    """Check if execution should pause at this point.
